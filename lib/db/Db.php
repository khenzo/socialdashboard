...
class Db
{
     ...
     */
    public static function setConnectionInfo($schema, $username = null, $password = null, $database = 'mysql', $hostname = DB_HOST)
    {
        if($database == 'mysql') {
    ...
    public static function getLastInsertId($sql, $params = array())
    {
    	$statement = self::_query($sql, $params);
        return self::$_pdoObject->lastInsertId(null);
    }
